...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(window.location.href=='http://auroracarlsberg.herokuapp.com/portfolio')
    {
    ...
    else if(window.location.href=='http://auroracarlsberg.herokuapp.com/comingsoon?b=')
    {
    ...
    else if(window.location.href=='http://auroracarlsberg.herokuapp.com/comingsoon?bcd=')
    {
      document.getElementById("npd").style.background='#5A5F66';
      document.getElementById("portfolio").style.background='#5A5F66';
      document.getElementById("plan").style.background='#5A5F66';
    ...
    else if(window.location.href=='http://auroracarlsberg.herokuapp.com/comingsoon?a=')
    {
    ...
    else if(window.location.href=='http://auroracarlsberg.herokuapp.com/setting')
    {
      document.getElementById("snop").style.background='#5A5F66';
      document.getElementById("portfolio").style.background='#5A5F66';
      document.getElementById("plan").style.background='#5A5F66';
  ...
  public onClick(name: string) {
    ...
    if(window.location.href=="http://auroracarlsberg.herokuapp.com/portfolio?%2F=")
    {
      window.location.href="http://auroracarlsberg.herokuapp.com/dashboard";
    }
  ...
  public goToPage(pageName:string){
    ...
    {
      this.num=1;
      window.location.href="http://auroracarlsberg.herokuapp.com/comingsoon?a"
     // this.router.navigate([`/portfolio`]);
    }
    else if(pageName=='b')
    {
      this.num=2;
      window.location.href="http://auroracarlsberg.herokuapp.com/comingsoon?b"
    }

    else if(pageName=='bcd')
    {
      this.num=56;
      window.location.href="http://auroracarlsberg.herokuapp.com/comingsoon?bcd"
    }

    else if(pageName=='ab')
    {
      this.num=2;
      window.location.href="http://auroracarlsberg.herokuapp.com/portfolio"
    }
    else if(pageName=='c')
    {
      this.num=3;
    ...
    {
      this.num=5;
      window.location.href="http://auroracarlsberg.herokuapp.com/setting"
    }
    ...
    else if(pageName=='f')
    {
      ...
      window.location.href="http://auroracarlsberg.herokuapp.com/login"
    }
