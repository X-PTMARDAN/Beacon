...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    else if(window.location.href=='http://aurora-carlsberg.herokuapp.com/comingsoon?b=')
    {
    ...
    else if(window.location.href=='http://aurora-carlsberg.herokuapp.com/comingsoon?bcd=')
    {
      document.getElementById("npd").style.background='#5A5F66';
      document.getElementById("portfolio").style.background='#5A5F66';
      document.getElementById("plan").style.background='#5A5F66';
    ...
    else if(window.location.href=='http://aurora-carlsberg.herokuapp.com/comingsoon?a=')
    {
  ...
  public goToPage(pageName:string){
    ...
    {
      this.num=1;
      window.location.href="http://aurora-carlsberg.herokuapp.com/comingsoon?a"
     // this.router.navigate([`/portfolio`]);
    }
    else if(pageName=='b')
    {
      this.num=2;
      window.location.href="http://aurora-carlsberg.herokuapp.com/comingsoon?b"
    }

    else if(pageName=='bcd')
    {
      this.num=56;
      window.location.href="http://aurora-carlsberg.herokuapp.com/comingsoon?bcd"
    }
